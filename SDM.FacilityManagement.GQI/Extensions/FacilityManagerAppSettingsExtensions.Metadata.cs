namespace Skyline.DataMiner.SDM.FacilityManagement.Common.Extensions
{
    ...
    public static partial class FacilityManagerAppSettingsExtensions
    {
        public static ObjectRefMetadata GetObjectRefMetadata(this SdmObject<FacilityManagerAppSettings> obj)
        {
