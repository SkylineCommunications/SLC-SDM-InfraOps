namespace Skyline.DataMiner.SDM.AssetManagement.Common.Extensions
{
    ...
    public static partial class AssetManagerAppSettingsExtensions
    {
        public static ObjectRefMetadata GetObjectRefMetadata(this SdmObject<AssetManagerAppSettings> obj)
        {
