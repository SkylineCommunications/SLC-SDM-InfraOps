...
namespace Skyline.DataMiner.SDM.AssetManagement.Models
{
	...
	public static partial class DeviceTypeExposers
	{
		...
		public static readonly Exposer<AssetManagement.Models.DeviceType, System.DateTime> CreatedAt = new Exposer<AssetManagement.Models.DeviceType, System.DateTime>((obj) => obj.CreatedAt, "CreatedAt");
		public static readonly Exposer<AssetManagement.Models.DeviceType, string> CreatedBy = new Exposer<AssetManagement.Models.DeviceType, string>((obj) => obj.CreatedBy, "CreatedBy");
		public static readonly Exposer<AssetManagement.Models.DeviceType, System.DateTime> LastModified = new Exposer<AssetManagement.Models.DeviceType, System.DateTime>((obj) => obj.LastModified, "LastModified");
		public static readonly Exposer<AssetManagement.Models.DeviceType, string> LastModifiedBy = new Exposer<AssetManagement.Models.DeviceType, string>((obj) => obj.LastModifiedBy, "LastModifiedBy");
        ...
        {
            RuntimeHelpers.RunClassConstructor(typeof(TagsInfo).TypeHandle);
            RuntimeHelpers.RunClassConstructor(typeof(HierarchyInfo).TypeHandle);
        }
