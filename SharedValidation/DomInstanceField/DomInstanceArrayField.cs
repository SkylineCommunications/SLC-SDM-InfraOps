namespace Skyline.DataMiner.Utils.InfraOps.Common.DOM_Classes.DOM.Applications.All.Fields
{
    ...
    public sealed class DomInstanceArrayField<T1> : IChangeTrackingField<List<T1>>, IDomInstanceFieldApplyChanges, IList<T1>, IReadOnlyList<T1>
	{
		...
		public DomInstanceArrayField(IEnumerable<T1> value, Action<List<T1>, List<T1>> applyChanges, Func<List<T1>, object> getChangesConverter = null)
		{
