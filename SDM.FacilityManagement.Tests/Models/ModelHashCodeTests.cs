namespace SDM.FacilityManagement.Tests.Models
{
    using System;
    ...
    /// Skyline.DataMiner.SDM.FacilityManagement.Models namespace. Guards against regressions such
    ...
    public class ModelHashCodeTests
    {
        ...
        {
            return typeof(Facility).Assembly
                .GetTypes()
                .Where(t => t.IsClass
                    && t.IsPublic
                    && !t.IsAbstract
                    && !t.IsGenericTypeDefinition
                    && t.Namespace == "Skyline.DataMiner.SDM.FacilityManagement.Models"
