namespace SDM.InfraOpsProperties.Tests.Models
{
    using System;
    ...
    /// Skyline.DataMiner.SDM.InfraOpsProperties.Models namespace. Guards against regressions such
    ...
    public class ModelHashCodeTests
    {
        ...
        {
            return typeof(PropertyValue).Assembly
                .GetTypes()
                .Where(t => t.IsClass
                    && t.IsPublic
                    && !t.IsAbstract
                    && !t.IsGenericTypeDefinition
                    && t.Namespace == "Skyline.DataMiner.SDM.InfraOpsProperties.Models"
