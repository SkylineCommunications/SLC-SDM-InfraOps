    ...
    internal partial class FacilityDomRepository : IBulkRepository<Facility>
	{
		...
		private Facility FromInstance(DomInstance instance)
		{
			...
			if (_facilitypropertiesSection != default)
			{
				...
				var _facilityid = _facilitypropertiesSection.GetValue<string>(FacilityManagement.Models.FacilityDomMapper.FacilityProperties.FacilityId);
				if (_facilityid != null)
				{
		...
		private DomInstance ToInstance(Facility obj)
		{
			...
			instance.StatusId = SharedMappers.DomIds.SlcFacility_Management.Behaviors.Facility_Behaviour.Statuses.ToValue(obj.State);
			var _facilityproperties = new Section(FacilityManagement.Models.FacilityDomMapper.FacilityProperties.SectionDefinitionId);
			...
			if (!obj.SiteFk.IsEmpty)
			{
				...
				if (obj.SiteFk.Site.HasValue())
				{
					_sitefk.AddOrUpdateValue<System.Guid>(FacilityManagement.Models.FacilityDomMapper.SiteFk.Site, Guid.Parse(obj.SiteFk.Site.Identifier));
				}
