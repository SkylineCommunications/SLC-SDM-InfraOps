...
namespace Skyline.DataMiner.SDM.FacilityManagement.Models
{
    ...
    internal partial class FacilityManagerAppSettingsDomRepository : IBulkRepository<FacilityManagerAppSettings>
    {
        ...
        public IReadOnlyCollection<FacilityManagerAppSettings> Create(IEnumerable<FacilityManagerAppSettings> createObjects)
        {
            if (createObjects is null || !createObjects.Any())
            {
                return Array.Empty<FacilityManagerAppSettings>();
            }

            var existing = new HashSet<string>();
            foreach (var batch in createObjects.Batch(500))
            {
                existing.UnionWith(Read(new ORFilterElement<FacilityManagerAppSettings>(batch.Select(obj => FacilityManagerAppSettingsExposers.Identifier.Equal(obj.Identifier)).ToArray())).Select(obj => obj.Identifier));
            }

            var successfulItems = new List<FacilityManagerAppSettings>();
            ...
            var exceptionBuilder = new SdmBulkCrudException<FacilityManagerAppSettings>.Builder();
            foreach (var obj in createObjects)
            {
                if (existing.Contains(obj.Identifier))
                {
                    exceptionBuilder.AddFailed(obj, new SdmCrudException<FacilityManagerAppSettings>(obj, $"Could not create FacilityManagerAppSettings with guid: '{obj.Identifier}', it already exists."));
                    continue;
                }
        ...
        public IReadOnlyCollection<FacilityManagerAppSettings> CreateOrUpdate(IEnumerable<FacilityManagerAppSettings> items)
        {
            ...
            var successful = new List<FacilityManagerAppSettings>();
            var exceptionBuilder = new SdmBulkCrudException<FacilityManagerAppSettings>.Builder();
        ...
        public long Count(FilterElement<FacilityManagerAppSettings> filter)
        {
            if (filter is null)
            {
        ...
        public long Count(IQuery<FacilityManagerAppSettings> query)
        {
            if (query is null)
            {
        ...
        public IEnumerable<FacilityManagerAppSettings> Read(FilterElement<FacilityManagerAppSettings> filter)
        {
            if (filter is null)
            {
                throw new ArgumentNullException(nameof(filter));
        ...
        public IEnumerable<FacilityManagerAppSettings> Read(IQuery<FacilityManagerAppSettings> query)
        {
            if (query is null)
            {
                throw new ArgumentNullException(nameof(query));
        ...
        public IEnumerable<IPagedResult<FacilityManagerAppSettings>> ReadPaged(FilterElement<FacilityManagerAppSettings> filter)
        {
            return ReadPaged(filter, 500);
        }

        public IEnumerable<IPagedResult<FacilityManagerAppSettings>> ReadPaged(FilterElement<FacilityManagerAppSettings> filter, int pageSize)
        {
            if (filter is null)
            {
                throw new ArgumentNullException(nameof(filter));
            ...
            while (moveNext)
            {
                ...
                var result = new PagedResult<FacilityManagerAppSettings>(page, i, pageSize, moveNext);
                yield return result;
                i++;
            }
        }

        public IEnumerable<IPagedResult<FacilityManagerAppSettings>> ReadPaged(IQuery<FacilityManagerAppSettings> query)
        {
            return ReadPaged(query, 500);
        }

        public IEnumerable<IPagedResult<FacilityManagerAppSettings>> ReadPaged(IQuery<FacilityManagerAppSettings> query, int pageSize)
        {
            if (query is null)
            {
                throw new ArgumentNullException(nameof(query));
        ...
        public FacilityManagerAppSettings Update(FacilityManagerAppSettings updateObject)
        {
        ...
        public IReadOnlyCollection<FacilityManagerAppSettings> Update(IEnumerable<FacilityManagerAppSettings> updateObjects)
        {
            ...
            foreach (var obj in updateObjects)
            {
                if (!existing.Contains(obj.Identifier))
                {
                    exceptionBuilder.AddFailed(obj, new SdmCrudException<FacilityManagerAppSettings>(obj, "Could not update a non existing FacilityManagerAppSettings"));
                    continue;
                }
        ...
        public void Delete(FacilityManagerAppSettings deleteObject)
        {
        ...
        public void Delete(IEnumerable<FacilityManagerAppSettings> deleteObjects)
        {
        ...
        private IEnumerable<FacilityManagerAppSettings> Read(FilterElement<DomInstance> domFilter)
        {
        ...
        private IEnumerable<FacilityManagerAppSettings> Read(IQuery<DomInstance> domQuery)
        {
            if (domQuery is null)
            {
        ...
        private IEnumerable<IEnumerable<FacilityManagerAppSettings>> ReadPaged(FilterElement<DomInstance> domFilter, int pageSize)
        {
            if (domFilter is null)
            {
                throw new ArgumentNullException(nameof(domFilter));
        ...
        private IEnumerable<IEnumerable<FacilityManagerAppSettings>> ReadPaged(IQuery<DomInstance> domQuery, int pageSize)
        {
            if (domQuery is null)
            {
                throw new ArgumentNullException(nameof(domQuery));
        ...
        private FilterElement<DomInstance> TranslateFullFilter(FilterElement<FacilityManagerAppSettings> filter)
        {
            if (filter is null)
            {
                throw new ArgumentNullException(nameof(filter));
            ...
            if (filter is ANDFilterElement<FacilityManagerAppSettings> and)
            {
                translated = new ANDFilterElement<DomInstance>(and.subFilters.Select(TranslateFullFilter).ToArray());
            }
            else if (filter is ORFilterElement<FacilityManagerAppSettings> or)
            {
                translated = new ORFilterElement<DomInstance>(or.subFilters.Select(TranslateFullFilter).ToArray());
            }
            else if (filter is NOTFilterElement<FacilityManagerAppSettings> not)
            {
                translated = new NOTFilterElement<DomInstance>(TranslateFullFilter(not));
            }
            else if (filter is TRUEFilterElement<FacilityManagerAppSettings>)
            {
                translated = new TRUEFilterElement<DomInstance>();
            }
            else if (filter is FALSEFilterElement<FacilityManagerAppSettings>)
            {
        ...
        private FacilityManagerAppSettings FromInstance(DomInstance instance)
        {
            var obj = new FacilityManagerAppSettings
            {
            ...
            if (_appsettingsSection != default)
            {
                ...
                var _appsettingsgooglemapsapikey = _appsettingsSection.GetValue<string>(FacilityManagement.Models.FacilityManagerAppSettingsDomMapper.AppSettings.GoogleMapsAPIKey);
                if (_appsettingsgooglemapsapikey != null)
                {
                    obj.GoogleMapsAPIKey = _appsettingsgooglemapsapikey.Value;
                }
            }
        ...
        private DomInstance ToInstance(FacilityManagerAppSettings obj)
        {
            ...
            var _appsettings = new Section(FacilityManagement.Models.FacilityManagerAppSettingsDomMapper.AppSettings.SectionDefinitionId);
